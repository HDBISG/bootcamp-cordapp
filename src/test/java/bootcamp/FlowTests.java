...
public class FlowTests {
    ...
    public void transactionConstructedByFlowHasOneTokenStateOutputWithTheCorrectAmountAndOwner() throws Exception {
        ...
        assertEquals(1, signedTransaction.getTx().getOutputStates().size());
        EcoState output = signedTransaction.getTx().outputsOfType(EcoState.class).get(0);

        assertEquals(nodeB.getInfo().getLegalIdentities().get(0), output.getVcc() );
        assertEquals("ecoContent", output.getEcoContent());
    }
    ...
    public void transactionConstructedByFlowHasOneOutputUsingTheCorrectContract() throws Exception {
        ...
        assertEquals("bootcamp.EcoContract", output.getContract());
    }
    ...
    public void transactionConstructedByFlowHasOneIssueCommand() throws Exception {
        ...
        assert (command.getValue() instanceof EcoIssueContract.Commands.Issue);
    }
